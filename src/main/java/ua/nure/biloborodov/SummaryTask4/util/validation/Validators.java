...
public class Validators {
    ...
    private static final Pattern LOGIN_PATTERN = Pattern.compile("^[a-z0-9_-]+$", Pattern.CASE_INSENSITIVE);
    ...
    public static String validateRegistrationForm(String login, String password, String firstName, String lastName,
	    String email) {
	String message = null;
    ...
    public static String validateTestForm(String testName, String time) {
	String message = null;
	if ((message = validateFields(testName, 50)) != null) {
	    return message;
	}
	if ((message = validateTime(time)) != null) {
	    return message;
	}
	return message;
    }
    
    public static String validateFields(String field, int length) {
	if (field.length() == 0) {
	    return "validate.field.cannot.be.empty";
	} else if (field.length() > length) {
	    return "validate.field.upto";
	}
	return null;
    }
